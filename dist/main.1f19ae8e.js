...
var CONTRACT_NAME = "dev-1640639075534-62569263574205" || 'token-contract-as';
/* TODO: fill this in! */
  ...
  switch (env) {
    ...
    case 'local':
      return {
        ...
        keyPath: "".concat("/home/mmednick", "/.near/validator_key.json"),
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return nearAPI.connect(Object.assign(nearConfig, {
              deps: {
          ...
          case 2:
            ...
            window.walletAccount = new nearAPI.WalletAccount(window.near); // Initializing our contract APIs by contract name and configuration.
